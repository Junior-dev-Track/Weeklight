        ...
        <?php if (!isset($_SESSION["user"])) : ?>
            <div class="container_login">
                <section class="about">
                    ...
                    <p class="text">Partagez, aimez et rappelez-vous<br><strong>des moments qui comptent vraiment pour vous</strong></p>
                </section>
            ...
            <section id="container_register">
                ...
                <form method="post">
                    ...
                    <p class="general_condition">En cliquant sur "s’inscrire", vous acceptez nos <a href="#" target="_blank">conditions générales</a>.</p>
                    <p class="general_condition">Découvrez comment nous recueillons, utilisons et partageons vos données en lisant notre <a href="#" target="_blank">politique de confidentialité</a> et comment nous utilisons les cookies et autres technologies similaires en consultant notre politique d’utilisation des cookies.</p>
                    <p class="general_condition">Vous recevrez peut-être des notifications par texto de notre part et vous pouvez à tout moment vous désabonner.</p>
